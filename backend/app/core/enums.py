...
class SystemAction(str, Enum):
    ...
    UPDATE_LEAVE_APPROVAL = "UPDATE_LEAVE_APPROVAL"
    DELETE_LEAVE_APPROVAL = "DELETE_LEAVE_APPROVAL"
...
def validate_permission_exists(permission: str) -> bool:
    """Validate that a permission string exists in the Permission enum."""
...
def validate_permissions_list(permissions: list[str]) -> tuple[bool, list[str]]:
    """Validate a list of permissions and return invalid ones."""
    valid_permissions = get_all_permission_values()
