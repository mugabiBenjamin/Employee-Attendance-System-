...
async def generate_attendance_csv_task(user_id: int, start_date: str, end_date: str, filename: str):
    ...
    async with AsyncSessionLocal() as session:
        try:
            ...
            logger.info(f"Attendance CSV generated for user_id: {user_id}, file: {filename}")
            return {"status": "success", "message": f"CSV generated: {filename}"}
        except Exception as e:
...
async def generate_attendance_pdf_task(user_id: int, start_date: str, end_date: str, filename: str):
    ...
    async with AsyncSessionLocal() as session:
        try:
            ...
            logger.info(f"Attendance PDF generated for user_id: {user_id}, file: {filename}")
            return {"status": "success", "message": f"PDF generated: {filename}"}
        except Exception as e:
...
def dispatch_csv_report(user_id: int, start_date: date, end_date: date) -> str:
    ...
    job = generate_attendance_csv_task.delay(user_id, str(start_date), str(end_date), filename)
...
def dispatch_pdf_report(user_id: int, start_date: date, end_date: date) -> str:
    ...
    job = generate_attendance_pdf_task.delay(user_id, str(start_date), str(end_date), filename)
